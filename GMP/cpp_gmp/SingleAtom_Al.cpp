...
int main(){
    ...
    double cart[2][3] = {{6.0,6.0,6.0},{8.0,8.0,8.0}};
    ...
    double scale[2][3] = {{0.4938271605,0.4938271605,0.4938271605},{0.658436214,0.658436214,0.658436214}};
    double *scale_p[2];
    double ** scale_all;
    ...
    int atom_num = 2;
    int cal_atoms[2];
    for (int i =0; i<2; i++) cal_atoms[i] = i;
    ...
    double *dx_p[2*15];
    double **dx_all;
    for (int i = 0; i < 2*15; i ++) dx_p[i] = dx[i];
    dx_all = dx_p;
